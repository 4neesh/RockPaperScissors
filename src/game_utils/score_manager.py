...
class StreakScoreManager(ScoreManager):
    ...
    def return_leaderboard(self) -> None:
        ...
        display_scores[f"{self._player_1_name} (streak: {self._player_1_streak})"] = display_scores.pop(self._player_1_name)
        display_scores[f"{self._player_2_name} (streak: {self._player_2_streak})"] = display_scores.pop(self._player_2_name)
